...
role: Third-year Mathematics Undergraduate
...
#     link: https://www.linkedin.com/
  - icon: cv
    icon_pack: ai
    link: uploads/personal_CV_en.pdf
...
<!-- {{< icon name="download" pack="fas" >}} Download my {{< staticref "uploads/personal_CV_en.pdf" "newtab" >}}resumé{{< /staticref >}}. -->
